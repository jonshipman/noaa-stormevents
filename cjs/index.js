...
async function DownloadFiles(links, suppressLogs = false) {
  ...
  for (const link of links) {
    ...
    const protocol = 0 === link.indexOf('https') ? require$$2 : http$3;
    if (!suppressLogs) {
...
is.buffer = value => {
  ...
  return (_value$constructor$is = value === null || value === void 0 ? void 0 : (_value$constructor = value.constructor) === null || _value$constructor === void 0 ? void 0 : (_value$constructor$is2 = _value$constructor.isBuffer) === null || _value$constructor$is2 === void 0 ? void 0 : _value$constructor$is2.call(_value$constructor, value)) !== null && _value$constructor$is !== void 0 ? _value$constructor$is : false;
};
...
is.generator = value => is.iterable(value) && is.function_(value === null || value === void 0 ? void 0 : value.next) && is.function_(value === null || value === void 0 ? void 0 : value.throw);
...
is.observable = value => {
  ...
  if (value === ((_value$Symbol$observa = value[Symbol.observable]) === null || _value$Symbol$observa === void 0 ? void 0 : _value$Symbol$observa.call(value))) {
    return true;
  }
...
const timer = request => {
  ...
  const handleError = origin => {
    origin.once(require$$0.errorMonitor, () => {
  ...
  const onSocket = socket => {
    ...
    if (require$$2$1.types.isProxy(socket)) {
      return;
    }
  ...
  const onUpload = () => {
    var _timings$secureConnec;
    timings.upload = Date.now();
    timings.phases.request = timings.upload - ((_timings$secureConnec = timings.secureConnect) !== null && _timings$secureConnec !== void 0 ? _timings$secureConnec : timings.connect);
  };
...
class Response extends require$$0$1.Readable {
  constructor({
    statusCode,
    headers,
    body,
...
const knownProperties$1 = ['aborted', 'complete', 'headers', 'httpVersion', 'httpVersionMinor', 'httpVersionMajor', 'method', 'rawHeaders', 'rawTrailers', 'setTimeout', 'socket', 'statusCode', 'statusMessage', 'trailers', 'url'];
  ...
  constructor(cacheRequest, cacheAdapter) {
    ...
    this.request = () => (options, cb) => {
      ...
      if (options.body && options.method !== undefined && ['POST', 'PATCH', 'PUT'].includes(options.method)) {
        if (options.body instanceof require$$0$1.Readable) {
      ...
      const makeRequest = options_ => {
        ...
        const handler = async response => {
          ...
          ee.emit('response', (_clonedResponse = clonedResponse) !== null && _clonedResponse !== void 0 ? _clonedResponse : response);
          if (typeof cb === 'function') {
            var _clonedResponse2;
            cb((_clonedResponse2 = clonedResponse) !== null && _clonedResponse2 !== void 0 ? _clonedResponse2 : response);
          }
        };
        try {
    ...
    this.runHook = async (name, ...args) => {
      var _this$hooks$get;
      return (_this$hooks$get = this.hooks.get(name)) === null || _this$hooks$get === void 0 ? void 0 : _this$hooks$get(...args);
    };
...
const cloneResponse = response => {
  const clone = new require$$0$1.PassThrough({
    autoDestroy: false
  });
...
const isFormData$1 = value => Boolean(value && isFunction(value.constructor) && value[Symbol.toStringTag] === "FormData" && isFunction(value.append) && isFunction(value.getAll) && isFunction(value.entries) && isFunction(value[Symbol.iterator]));

const escapeName = name => String(name).replace(/\r/g, "%0D").replace(/\n/g, "%0A").replace(/"/g, "%22");

const isFile = value => Boolean(value && typeof value === "object" && isFunction(value.constructor) && value[Symbol.toStringTag] === "File" && isFunction(value.stream) && value.name != null);
...
async function getBodySize(body, headers) {
  ...
  if (is.string(body)) {
    return require$$0$2.Buffer.byteLength(body);
  }
  if (is.buffer(body)) {
    return body.length;
  }
  if (isFormData(body)) {
    return require$$2$1.promisify(body.getLength.bind(body))();
  }
  return undefined;
}
...
function timedOut(request, delays, options) {
  ...
  const addTimeout = (delay, callback, event) => {
    ...
    (_timeout$unref = timeout.unref) === null || _timeout$unref === void 0 ? void 0 : _timeout$unref.call(timeout);
    const cancel = () => {
...
class CacheableLookup {
  constructor({
    ...
    this._dnsLookup = lookup && require$$2$1.promisify(lookup);
    this.stats = {
      cache: 0,
      query: 0
    };
    if (this._resolver instanceof AsyncResolver) {
      ...
      this._resolve4 = require$$2$1.promisify(this._resolver.resolve4.bind(this._resolver));
      this._resolve6 = require$$2$1.promisify(this._resolver.resolve6.bind(this._resolver));
    }
...
let Agent$4 = class Agent extends EventEmitter {
  constructor({
    ...
    this.tlsSessionCache = new QuickLRU$1({
...
class Options {
  constructor(input, options, defaults) {
    var _ref, _defaults$_internals, _defaults$_init;
    ...
    this._internals = cloneInternals((_ref = (_defaults$_internals = defaults === null || defaults === void 0 ? void 0 : defaults._internals) !== null && _defaults$_internals !== void 0 ? _defaults$_internals : defaults) !== null && _ref !== void 0 ? _ref : defaultInternals);
  ...
  */
  ...
  set cookieJar(value) {
    ...
    if (setCookie.length === 4 && getCookieString.length === 0) {
      setCookie = require$$2$1.promisify(setCookie.bind(value));
      getCookieString = require$$2$1.promisify(getCookieString.bind(value));
  ...
  */
  ...
  [Symbol.for('nodejs.util.inspect.custom')](_depth, options) {
    return require$$2$1.inspect(this._internals, options);
  }
  createNativeRequestOptions() {
    ...
    return {
      ...
      checkServerIdentity: (_https$checkServerIde = https.checkServerIdentity) !== null && _https$checkServerIde !== void 0 ? _https$checkServerIde : require$$0$3.checkServerIdentity,
  ...
  getFallbackRequestFunction() {
    ...
    if (url.protocol === 'https:') {
      ...
      return require$$2.request;
    }
    return http$3.request;
  }
  freeze() {
...
const proxiedRequestEvents$1 = ['socket', 'connect', 'continue', 'information', 'upgrade'];
const noop = () => {};
class Request extends require$$0$1.Duplex {
  ...
  async flush() {
    ...
    try {
      ...
      if (this.destroyed) {
        var _this$_request;
        (_this$_request = this._request) === null || _this$_request === void 0 ? void 0 : _this$_request.destroy();
        return;
      }
      // Queued writes etc.
  ...
  _beforeError(error) {
    ...
    void (async () => {
      var _this$_request2, _this$_request2$socke;
      ...
      if (response !== null && response !== void 0 && response.readable && !response.rawBody && !((_this$_request2 = this._request) !== null && _this$_request2 !== void 0 && (_this$_request2$socke = _this$_request2.socket) !== null && _this$_request2$socke !== void 0 && _this$_request2$socke.destroyed)) {
  ...
  _final(callback) {
    const endRequest = () => {
      ...
      this._request.end(error => {
        var _this$_request$_writa;
        // The request has been destroyed before `_final` finished.
        // See https://github.com/nodejs/node/issues/39356
        if ((_this$_request$_writa = this._request._writableState) !== null && _this$_request$_writa !== void 0 && _this$_request$_writa.errored) {
          return;
        }
        if (!error) {
  ...
  async _onResponseBase(response) {
    ...
    typedResponse.statusMessage = (_typedResponse$status = typedResponse.statusMessage) !== null && _typedResponse$status !== void 0 ? _typedResponse$status : http$3.STATUS_CODES[statusCode];
    ...
    if (options.followRedirect && response.headers.location && redirectCodes.has(statusCode)) {
      ...
      try {
        ...
        const redirectBuffer = require$$0$2.Buffer.from(response.headers.location, 'binary').toString();
  ...
  _sendBody() {
    ...
    const currentRequest = this.redirectUrls.length === 0 ? this : (_this$_request3 = this._request) !== null && _this$_request3 !== void 0 ? _this$_request3 : this;
    if (is.nodeStream(body)) {
  ...
  async _makeRequest() {
    ...
    if (username || password) {
      const credentials = require$$0$2.Buffer.from(`${username}:${password}`).toString('base64');
  ...
  _writeRequest(chunk, encoding, callback) {
    ...
    this._request.write(chunk, encoding, error => {
      ...
      if (!error && !this._request.destroyed) {
        this._uploadedSize += require$$0$2.Buffer.byteLength(chunk, encoding);
  ...
  */
  ...
  get socket() {
    var _this$_request$socket, _this$_request4;
    return (_this$_request$socket = (_this$_request4 = this._request) === null || _this$_request4 === void 0 ? void 0 : _this$_request4.socket) !== null && _this$_request$socket !== void 0 ? _this$_request$socket : undefined;
  }
  /**
  ...
  */
  get timings() {
    var _this$_request5;
    return (_this$_request5 = this._request) === null || _this$_request5 === void 0 ? void 0 : _this$_request5.timings;
  }
  /**
  ...
  */
  ...
  get reusedSocket() {
    var _this$_request6;
    return (_this$_request6 = this._request) === null || _this$_request6 === void 0 ? void 0 : _this$_request6.reusedSocket;
  }
}
...
function asPromise(firstRequest) {
  ...
  const emitter = new require$$0.EventEmitter();
  const promise = new PCancelable((resolve, reject, onCancel) => {
    ...
    const makeRequest = retryCount => {
      var _firstRequest, _request$options;
      // Errors when a new request is made after the promise settles.
      // Used to detect a race condition.
      // See https://github.com/sindresorhus/got/issues/1489
      onCancel(() => {});
      const request = (_firstRequest = firstRequest) !== null && _firstRequest !== void 0 ? _firstRequest : new Request(undefined, undefined, normalizedOptions);
...
async function PullLinks() {
  ...
  try {
    response = await got$1(Config.url);
  } catch (e) {
  ...
  const links = response.body.match(/<a[^>]*>([^<]+)<\/a>/g).filter(x => x.includes('.csv.gz')).map(x => {
    return x.match(/href="(.*?)"/)[1];
  }).map(a => Config.url + '/' + a).filter(a => !history.includes(a));
  return links;
}

const pipeline = require$$2$1.promisify(require$$0$1.pipeline);
